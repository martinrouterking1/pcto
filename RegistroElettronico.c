...
void studente (char nomestudente, char cognomestudente, char etastudente, char annofrequentato);
void professore (char nomeprofessore, char cognomeprofessore, char etaprofessore, char corsoprofessore); 
...
int main (){
    ...
    int i=0;
     if (strcmp(ruolo, "1") == 0) {
        professore(char nomestudente, char cognomestudente, char etastudente, char annofrequentato);
     }
     if (strcmp(ruolo, "2") == 0) {
        studente(char nomeprofessore, char cognomeprofessore, char etaprofessore, char corsoprofessore);
     }
     if (strcmp(ruolo, "Professore") == 0) {
        professore(char nomestudente, char cognomestudente, char etastudente, char annofrequentato);
     }
...
void studente () {
    printf("\nBenvenuto! \n");
        ...
        if (strcmp(conferma, "Confermo")==0 || (strcmp(conferma, "Si"))==0 || (strcmp(conferma, "si"))==0){
            ...
            sleep (1);
            selezionemateria:
            printf("\nSeleziona una materia per inserire i voti e calcolare la media.\n\n1. Matematica\n2. Fisica\n3. Italiano\n4. Latino\n5. Greco\n6. Inglese\n7. Storia\n8. Filosofia\n9. Scienze\n10. Scienze motorie\n\n");
